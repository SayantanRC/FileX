...
| file           | File?                                       | FileX11<br>(`isTraditional`<br>=true)  | Returns raw Java File.<br>Maybe useful for `FileXT`. But usually not of much use for `FileX11` as the returned File object cannot be read from or written to.                                                                                           |
